...
public class GerritWebHookTriggerTest {
  ...
  public void gerritWebHookTriggerNoFolderTest() throws Exception {
    ...
    gs.setTraits(new ArrayList<SCMSourceTrait>(Arrays.asList(new BranchDiscoveryTrait(), new WildcardSCMHeadFilterTrait("*", ""))));
    ...
    HttpResponse<String> resp = Unirest.post(j.jenkins.getRootUrl() + "gerrit-webhook/")
