...
class UTCTimestampTypeAdapter extends TypeAdapter<Timestamp> {
  ...
  public Timestamp read(JsonReader in) throws IOException {
    ...
    try {
      // Gerrit responses may expand fractional seconds to nanosecond width. Parse the fraction as
      // a fraction of one second; SimpleDateFormat would incorrectly treat all digits as millis.
