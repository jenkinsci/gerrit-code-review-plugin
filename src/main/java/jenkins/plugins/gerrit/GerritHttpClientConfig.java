...
/**
 * Applies bounded, system-property-overridable timeouts, a method-aware retry policy, and disabled
 * redirects for both Gerrit HTTP clients.
 *
 * <ul>
...
public final class GerritHttpClientConfig extends HttpClientBuilderExtension {
  ...
  /**
   * Configures the pool-acquisition, TCP-connect, and socket-inactivity timeouts, one automatic
   * retry for safe requests, and disabled redirects.
   *
  ...
  static HttpRequestRetryHandler retryHandler() {
    return new DefaultHttpRequestRetryHandler(1, false);
  }
