...
/**
 * Applies bounded, system-property-overridable timeouts and disables automatic retries and
 ...
 *   <li>{@value #SOCKET_TIMEOUT_PROPERTY}: socket inactivity, default 60000 ms
 * </ul>
 *
...
public final class GerritHttpClientConfig extends HttpClientBuilderExtension {
  ...
  /**
   * Configures the pool-acquisition, TCP-connect, and socket-inactivity timeouts and disables
