    ...
    protected Void run() throws Exception {
      ...
      if (gerritRestApiWrapper != null) {
        ...
        if (!matcher.matches()) {
          ...
          listener.getLogger().format("Gerrit review change %d/%d label %s=%d (%s)%n", changeId, revision, label, score, message);
          ...
          gerritRestApiWrapper.postRequest("/changes/" + changeId + "/revisions/" + revision + "/review", jsonPayload);
        }
      }
      return null;
    }
