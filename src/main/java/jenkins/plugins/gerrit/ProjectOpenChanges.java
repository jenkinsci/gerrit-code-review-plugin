...
class ProjectOpenChanges {
	private ConcurrentHashMap<Integer, ChangeInfo> openChanges = new ConcurrentHashMap<>();
	...
	public Optional<ChangeInfo> get(int changeNumber) {
		// TODO: Fetch from Gerrit if not cached locally
	...
	public void remove(int changeNumber) {
		openChanges.remove(changeNumber);
	}
}
