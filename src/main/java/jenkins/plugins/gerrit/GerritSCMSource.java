  ...
  public void afterSave() {
    ...
    if (context.createChecker()) {
      ...
      try {
        ...
        Optional<String> rootUrl = Optional.of(Jenkins.getInstance().getRootUrl());
        Optional<String> path = Optional.of(getOwner().getUrl());
        if (rootUrl.isPresent() && path.isPresent()) {
          checker.url = rootUrl.get() + path.get();
        }
  ...
  public static class DescriptorImpl extends SCMSourceDescriptor {
    ...
    public List<SCMSourceTrait> getTraitsDefaults() {
      return Arrays.<SCMSourceTrait>asList(
          new ChangeDiscoveryTrait(), new RefSpecsSCMSourceTrait(REF_SPEC_DEFAULT));
    }
