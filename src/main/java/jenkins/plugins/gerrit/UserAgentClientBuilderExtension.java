...
class UserAgentClientBuilderExtension extends HttpClientBuilderExtension {
  ...
  private static String getCurrentVersion() {
    ...
    Optional<Properties> jarProperties = Optional.of(pluginClassLoader.getResource(
            "META-INF/maven/org.jenkins-ci.plugins/gerrit-code-review/pom.properties")).map(UserAgentClientBuilderExtension::loadProperties);
